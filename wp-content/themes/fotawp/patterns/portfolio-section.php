 ...
 * Categories: fotawp, fotawp-portfolio
 */
      ...
      <div class="wp-block-group"><!-- wp:columns {"verticalAlignment":"center","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|40"},"blockGap":{"top":"var:preset|spacing|80","left":"var:preset|spacing|80"}}}} -->
        <div class="wp-block-columns are-vertically-aligned-center" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:column {"verticalAlignment":"center"} -->
          <div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"level":6,"textColor":"sub-heading-color"} -->
            <h6 class="wp-block-heading has-sub-heading-color-color has-text-color"><?php echo esc_html_e('/ Project 01', 'fotawp') ?></h6>
            <!-- /wp:heading -->

            <!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"3em","fontStyle":"normal","fontWeight":"600","lineHeight":"1"}},"textColor":"heading-color"} -->
            <h1 class="wp-block-heading has-heading-color-color has-text-color" style="font-size:3em;font-style:normal;font-weight:600;line-height:1"><?php echo esc_html_e('ERP/CRM Development and Integrate!', 'fotawp') ?></h1>
            <!-- /wp:heading -->

            <!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}},"textColor":"foreground"} -->
            <p class="has-foreground-color has-text-color" style="font-size:18px"><?php echo esc_html_e('Every project is different and so should the process be. We’ll define a clear framework of how we communicate, exchange feedback and effectively work together.', 'fotawp') ?></p>
            <!-- /wp:paragraph -->
        ...
        <div class="wp-block-columns are-vertically-aligned-center" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:column {"verticalAlignment":"center"} -->
          ...
          <!-- wp:column {"verticalAlignment":"center"} -->
          <div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"level":6,"textColor":"sub-heading-color"} -->
            <h6 class="wp-block-heading has-sub-heading-color-color has-text-color"><?php echo esc_html_e('/ Project 02', 'fotawp') ?></h6>
            <!-- /wp:heading -->

            <!-- wp:heading {"level":1,"style":{"typography":{"fontSize":"3em","fontStyle":"normal","fontWeight":"600","lineHeight":"1"}},"textColor":"heading-color"} -->
            <h1 class="wp-block-heading has-heading-color-color has-text-color" style="font-size:3em;font-style:normal;font-weight:600;line-height:1"><?php echo esc_html_e('Case Study for AI Impact on Modern Technology', 'fotawp') ?></h1>
            <!-- /wp:heading -->
